...
public class BhanuCNN {

    private static final Logger logger = LoggerFactory.getLogger(BhanuCNN.class);
    ...
    private AgeCNN ageDetector = new AgeCNN();
    private GenderCNN genderDetector = new GenderCNN();
        ...
        while (running) {
            try {
                ...
                detectedFaces.entrySet().forEach(rectMatEntry -> {
                    ...
                    GenderCNN.Gender gender = genderDetector.predictGender(rectMatEntry.getValue(), frame);
    ...
    public static void main(String[] args) {
        BhanuCNN BhanuCNN = new BhanuCNN();

        logger.info("Starting javacv example");
        new Thread(BhanuCNN::start).start();
