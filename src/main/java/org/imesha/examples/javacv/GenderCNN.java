 ...
 */
public class GenderCNN {

    private static final Logger logger = LoggerFactory.getLogger(GenderCNN.class);
    ...
    public GenderCNN() {
        try {
            ...
            throw new IllegalStateException("Unable to start GenderCNN", e);
        }
    }
